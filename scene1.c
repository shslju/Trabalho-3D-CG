...
#include <gl/glut.h>
int face_culling = 0;
GLfloat x_ok = 2.0f, y_ok = 2.0f, z_ok = 2.0f;
GLfloat angle = 30;
...
void display()
{
    ...
    // PARTE DA FRENTE DO BULE RENDERIZADO COM INDEXAÇÃO EM DIREÇÃO HORÁRIA
    glFrontFace(GL_CW);
